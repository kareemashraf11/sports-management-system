<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="assocRegister.aspx.cs" Inherits="DBProject.assocRegister" %>
...
<body>
    <form id="form1" runat="server" class="form">
        <div class="container2">
            <center>
                <h3>Association Manager Registeration Form</h3>
                <br />
                <h3>Name</h3>
                ...
                <br /><br />
                <h3>Username</h3>
                <asp:TextBox ID="Username" runat="server" placeholder="Enter Userame"></asp:TextBox>
