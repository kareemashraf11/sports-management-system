<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addStadium.aspx.cs" Inherits="DBProject.WebForm6" %>
    ...
    <form id="form1" runat="server" class="form">
        <div class="container2">
            <center>
                ...
                <h3>Stadium Name</h3>
                <br />
                <asp:TextBox ID="stadium" runat="server" placeholder="Enter Stadium Name"></asp:TextBox>
                <asp:Label ID="Label1" runat="server" Text=" " class="err"></asp:Label>
                <br /> <br />
                <h3>Stadium Location</h3>
                <br />
                <asp:TextBox ID="location" runat="server" placeholder="Enter Stadium Location"></asp:TextBox>
                <asp:Label ID="Label2" runat="server" Text=" " class="err"></asp:Label>
                <br /> <br />
                <h3>Stadium Capacity</h3>
                <br />
                <asp:TextBox ID="capacity" runat="server" placeholder="Enter Stadium Capacity"></asp:TextBox>
