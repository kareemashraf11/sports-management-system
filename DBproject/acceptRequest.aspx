<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="acceptRequest.aspx.cs" Inherits="DBProject.acceptRequest" %>
    ...
    <form id="form1" runat="server" class="form">
        <div class="container2">
            <center>
                ...
                <br />
                <br />
                <asp:Button ID="accept" runat="server" Text="Accept" class="btn" OnClick="accept_Click" />
                <br />
