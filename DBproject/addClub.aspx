<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addClub.aspx.cs" Inherits="DBProject.addClub" %>
    ...
    <form id="form1" runat="server" class="form">
        <div class="container2">
            <center>
                ...
                <h3>Club Location</h3>
                <br />
                <asp:TextBox ID="location" runat="server" placeholder="Enter Club Location"></asp:TextBox>
