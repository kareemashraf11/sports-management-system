<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rejectRequest.aspx.cs" Inherits="DBProject.rejectRequest" %>
    ...
    <form id="form1" runat="server" class="form">
        <div class="container2">
            <center>
                ...
                <br /> <br /> <br />
                <asp:Button ID="reject" runat="server" Text="Reject" class="btn" OnClick="reject_Click" />
                <br />
